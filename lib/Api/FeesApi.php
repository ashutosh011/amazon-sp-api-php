...
use Ashutosh\AmazonSellingPartnerAPI\Models\ProductFees\GetMyFeesEstimateResponse;
...
class FeesApi
{
     ...
     *
     * @param \Ashutosh\AmazonSellingPartnerAPI\Models\ProductFees\GetMyFeesEstimateRequest $body body (required)
     * @param string                                                                        $asin The Amazon Standard Identification Number (ASIN) of the item. (required)
     *
     * @throws \InvalidArgumentException
     * @throws \Ashutosh\AmazonSellingPartnerAPI\ApiException on non-2xx response
     *
     * @return \Ashutosh\AmazonSellingPartnerAPI\Models\ProductFees\GetMyFeesEstimateResponse
     */
     ...
     *
     * @param \Ashutosh\AmazonSellingPartnerAPI\Models\ProductFees\GetMyFeesEstimateRequest $body (required)
     * @param string                                                                        $asin The Amazon Standard Identification Number (ASIN) of the item. (required)
     *
     * @throws \InvalidArgumentException
     * @throws \Ashutosh\AmazonSellingPartnerAPI\ApiException on non-2xx response
     *
     * @return array of \Ashutosh\AmazonSellingPartnerAPI\Models\ProductFees\GetMyFeesEstimateResponse, HTTP status code, HTTP response headers (array of strings)
     */
