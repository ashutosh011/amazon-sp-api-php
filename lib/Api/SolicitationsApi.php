...
use Ashutosh\AmazonSellingPartnerAPI\Models\Solicitations\CreateProductReviewAndSellerFeedbackSolicitationResponse;
use Ashutosh\AmazonSellingPartnerAPI\Models\Solicitations\GetSolicitationActionsForOrderResponse;
...
class SolicitationsApi
{
     ...
     *
     * @return \Ashutosh\AmazonSellingPartnerAPI\Models\Solicitations\CreateProductReviewAndSellerFeedbackSolicitationResponse
     */
     ...
     * @throws \InvalidArgumentException
     *
     * @return array of \Ashutosh\AmazonSellingPartnerAPI\Models\Solicitations\CreateProductReviewAndSellerFeedbackSolicitationResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Ashutosh\AmazonSellingPartnerAPI\Models\Solicitations\CreateProductReviewAndSellerFeedbackSolicitationResponse';
        $request = $this->createProductReviewAndSellerFeedbackSolicitationRequest($amazon_order_id, $marketplace_ids);
     ...
     * @throws \InvalidArgumentException
     *
     * @return \Ashutosh\AmazonSellingPartnerAPI\Models\Solicitations\GetSolicitationActionsForOrderResponse
     */
     ...
     * @throws \InvalidArgumentException
     *
     * @return array of \Ashutosh\AmazonSellingPartnerAPI\Models\Solicitations\GetSolicitationActionsForOrderResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Ashutosh\AmazonSellingPartnerAPI\Models\Solicitations\GetSolicitationActionsForOrderResponse';
        $request = $this->getSolicitationActionsForOrderRequest($amazon_order_id, $marketplace_ids);
